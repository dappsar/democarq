...
using demo.Application.DTOs.Settings;
...
using demo.Infrastructure.Identity.Services;
using demo.Infrastructure.Shared.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\demo.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
